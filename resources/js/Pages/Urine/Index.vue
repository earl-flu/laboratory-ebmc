...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-4">
      <div class="breadcrumb-title pe-3">Urines</div>
      <div class="ps-3">
        ...
        <div class="card w-100 rounded-4">
          <div class="card-body">
            <div class="d-flex align-items-start justify-content-between mb-4">
              <div class="">
                <h5 class="mb-0 mt-3">All Urine Results</h5>
              </div>
            </div>
            ...
            <div class="d-flex align-items-start justify-content-between mb-4">
              ...
              <Link
                ...
                :href="route('urines.create')"
              >
                <i class="bi bi-plus-lg me-2"></i>Add New Urine
              </Link>
            </div>
              ...
              <table class="table align-middle table-hover">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>{{ urine.age }}</td>
                    <td>{{ urine.sex }}</td>
                    <td>{{ formatDate(urine.date_of_report) }}</td>
                    <td>
                      <div class="d-flex align-items-center gap-1">
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" style="">
                            <Link
                              :href="route('urines.edit', urine)"
                            >
                              <a class="dropdown-item" href="javascript:;"
                                ><i class="bi bi-pencil-square me-2"></i>Edit</a
                              >
                            </Link>
                            <a :href="route('urines.print', urine)" target="_blank" class="dropdown-item">
